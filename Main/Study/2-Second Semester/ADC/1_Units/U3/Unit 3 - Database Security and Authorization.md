...
2. Privilege Granting - *discretionary access control*
3. Privilege Revocation - *discretionary access control*
...
1. Horizontal Propagation - *limiting the no of users that can be granted By B*
2. Vertical Propagation - *refers to the depth of access that can be granted by B*
