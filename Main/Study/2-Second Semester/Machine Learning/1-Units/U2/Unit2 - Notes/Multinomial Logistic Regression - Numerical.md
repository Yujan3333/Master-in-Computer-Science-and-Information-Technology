...
* $y^{(i)}$ → raw score for class $i$ (NOT probability, just a number)
...
$$\hat y-y=(0.290-1,0.355-0,0.355-0)=(-0.710,0.355,0.355)$$
...
$$w=(0.0645,0.1965,0.28225)$$

---

## STEP 4: SGD → Sample 2 (Shortened)
...
Error:
$$\hat y-y=(0.21,-0.57,0.36)$$

Update weights again using:
$$w=w-\alpha(\hat y-y)x$$
