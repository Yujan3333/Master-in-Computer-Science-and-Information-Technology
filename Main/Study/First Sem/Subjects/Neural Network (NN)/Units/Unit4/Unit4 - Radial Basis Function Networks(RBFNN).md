...
---
### Slide Topic
1. [Kernel Methods](U4-Notes/Kernel%20Methods.md)
...
2. [RBF Basis Function Network](U4-Notes/RBF%20Basis%20Function%20Network.md)

3. [K-means Clustering Algorithm](U4-Notes/K-means%20Clustering%20Algorithm.md)
	- [Numerical of K-means](U4-Notes/Numerical%20of%20K-means.md)

4. [Training RBF Hidden Layer Using K-means](U4-Notes/Training%20RBF%20Hidden%20Layer%20Using%20K-means.md)
	- [Numerical On RBF Hidden Layer Using K-means](U4-Notes/Numerical%20On%20RBF%20Hidden%20Layer%20Using%20K-means.md)

5. [LMS Estimation of weight vector](U4-Notes/LMS%20Estimation%20of%20weight%20vector.md)
