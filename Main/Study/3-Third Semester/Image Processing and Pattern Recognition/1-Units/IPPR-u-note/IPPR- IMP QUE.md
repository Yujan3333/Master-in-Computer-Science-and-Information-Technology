...
| 2075        | Write short notes on (any two): a) [Hough transform](Hough%20transform.md) b) [Bandpass Filter](Bandpass%20Filter.md) c) [Smoothing vs Sharpening](Smoothing%20vs%20Sharpening.md) [2.5+2.5]                                                                            |
| 2074 (new)  | Explain the FFT algorithm for the one-dimensional case. [7] [FFT algo - one dimensional case](FFT%20algo%20-%20one%20dimensional%20case.md)                                                                                                                             |
| 2074 (new)  | Explain the Laplacian filter with an example. Derive the filter mask for hyperbolic filter and write the algorithm for its implementation. [2+6+2] [Laplacian filter - hyperbolic filter algo](Laplacian%20filter%20-%20hyperbolic%20filter%20algo.md)                  |
| 2074 (new)  | How do you determine sequency in Hadamard transform from the natural order? Explain with example. [Hadamard transform](Hadamard%20transform.md)                                                                                                                         |
