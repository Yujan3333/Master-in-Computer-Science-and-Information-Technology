...
- [Perfect Secrecy-Shift Cipher Achieves Perfect Secrecy](AC-Old%20Que/Perfect%20Secrecy-Shift%20Cipher%20Achieves%20Perfect%20Secrecy.md)
- Q. Define a substitution cipher and explain how it differs from the Shift cipher in terms of the key used. [3+2] 
	- [Substitution cipher vs Shift cipher](AC-Old%20Que/Substitution%20cipher%20vs%20Shift%20cipher.md)
---
#### ACrpto-2081
![](../../../../../Images/Third_Sem_Images/AC%20-%20Old%20Questions-2081.png)
![](../../../../../Images/Third_Sem_Images/AC%20-%20Old%20Questions-2081-1.png)
- Describe the Linear Feedback Shift Registers (LFSRs) in generating pseudorandom keystreams. Given an LFSR with a feedback polynomial $x^4 + x^3 + 1$ and an initial state $[1, 0, 1, 1]$, generate the first 8 bits of the keystream.
	- [LFSR-Example](AC-Old%20Que/LFSR-Example.md)
...
6. What can be the value of discrete logarithm of 4 under modulo 13 with the base 3.
