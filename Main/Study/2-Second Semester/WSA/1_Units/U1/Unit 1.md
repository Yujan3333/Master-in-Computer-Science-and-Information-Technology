...
### [Basic Element of Intelligent Applications](U1_Notes/Basic%20Element%20of%20Intelligent%20Applications.md)
   ...
   2. **Reference Structures** – frameworks like **dictionaries, knowledge bases, or ontologies** that give meaning and structure to the content (e.g., through tagging or folksonomy).
   3. **Algorithms** – analytical modules that extract patterns from data to enable **generalization, prediction,** and **better user interaction**.
##### Flowchart
![](../../../../../../Images/Second_Sem_Images/Unit%201-%203%20essence%20of%20intelligent%20syst.png)

### What applications can benefit from intelligence
1. Social Networking Site
	- Collection of the Big 3
2. [Mashups](U1_Notes/Mashups.md)
3. [Portals](U1_Notes/Portals.md)
...
- Get more Data from the Web
	- [Crawling](U1_Notes/Crawling.md) and [Screen Scraping](U1_Notes/Screen%20Scraping.md)
...
6. Computation time is known
7. Complicated models are better. [KISS]
