...
$$
\begin{flalign*}
\lvert x - y \rvert^2 & \text{ represents the squared Euclidean distance between the two data points} \\
\sigma & \text{ is a parameter known as the bandwidth or width of the kernel, controlling the smoothness of the decision boundary.}
\end{flalign*}
