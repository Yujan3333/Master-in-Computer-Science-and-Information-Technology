...
1. [Class Diagram](Class%20Diagram.md): To represent the static structure of classes, their attributes, operations, and relationships.

2. [Object Diagram](../../Unit1/Unit1-ZNotes/Object%20Diagram.md): To show instances of classes and their relationships at a specific point in time.

3. **State Transition Diagrams:** To illustrate the dynamic behavior of objects by showing how their states change in response to events. [State Diagram](../../Unit1/Unit1-ZNotes/State%20Diagram.md)
...
6. **Interaction Diagrams:** To model the flow of messages between objects over time (similar to [Sequence Diagram](../../Unit1/Unit1-ZNotes/Sequence%20Diagram.md)).
